...
class ModelArguments:
    ...
    flash_attention_2: bool = field(
        default=False,
        metadata={"help": "Whether or not to enable Flash Attention 2.0."},
    )
...
def main():
    ...
    if model_args.model_name_or_path:
        model = model_class.from_pretrained(
            ...
            use_flash_attention_2=model_args.flash_attention_2,
    ...
    if training_args.do_train:
        ...
        if not model_args.flash_attention_2:
            ...
            # don't double-dip in flash attention
            train_result = trainer.train(resume_from_checkpoint=checkpoint)
        trainer.save_model("model.pt")  # Saves the tokenizer too for easy upload
